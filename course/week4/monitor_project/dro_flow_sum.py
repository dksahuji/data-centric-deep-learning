...
from src.systems import ReviewDataModule, RobustSentimentSystem_naive
...
class DistRobustOpt(FlowSpec):
  ...
  config_path = Parameter('config', 
    help = 'path to config file', default = join(CONFIG_DIR, 'dro_sum.json'))
  ...
  def init_system(self):
    ...
    system = RobustSentimentSystem_naive(config)
  ...
  def offline_test(self):
    ...
    log_file = join(LOG_DIR, 'dro_sum_flow', 'results.json')
